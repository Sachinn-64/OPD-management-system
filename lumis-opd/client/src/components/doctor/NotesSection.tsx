...
export const NotesSection: React.FC<NotesSectionProps> = ({ visitId: _visitId, initialData, onSave }) => {
  ...
  }, [initialData?.chiefComplaint, initialData?.examination]);
  ...
  const noteFields = [
    { key: 'chiefComplaint', label: 'Chief Complaint', placeholder: 'Main reason for visit, primary symptoms...' },
    { key: 'examination', label: 'Examination Findings', placeholder: 'Physical examination findings, observations...' },
  ];
